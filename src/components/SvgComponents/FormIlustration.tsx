export default function FormIlustration() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="400" height="593" viewBox="0 0 400 593">
      <defs>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <path fill="url(#b)" fillRule="nonzero" d="M0 0h400v593H0z" mask="url(#c)"/>
        <g mask="url(#c)">
          ...
          <g transform="translate(-176 226)">
            ...
            <circle cx="390" cy="244" r="158" fill="url(#k)" fillRule="nonzero" mask="url(#l)"/>
            <circle cx="136.446" cy="-34.554" r="158" fill="url(#k)" fillRule="nonzero" mask="url(#l)" transform="rotate(-135 136.446 -34.554)"/>
          </g>
          ...
          <g fillRule="nonzero" transform="translate(129 115)">
            ...
            <g transform="translate(16 9)"><circle cx="6.5" cy="6.5" r="6.5" fill="#FF6464"/>
        ...
        <g transform="translate(246 93)">
          <path fill="#FFF" fillRule="nonzero" d="M0 4a4 4 0 0 1 4-4h90a4 4 0 0 1 4 4v122a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V4Z"/>
          <mask id="s" fill="#fff">
            <use xlinkHref="#q"/>
          </mask>
          <use xlinkHref="#q" fill="#FFF" fillRule="nonzero"/>
          <path fill="url(#r)" fillRule="nonzero" d="M108.12 28.878a3 3 0 0 1 .002 4.243L82.847 58.41c-4.348 4.351-11.4 4.351-15.749 0a5.132 5.132 0 0 0-7.26 0L42.406 75.853a8.668 8.668 0 0 1-12.262 0 2.668 2.668 0 0 0-3.774 0l-32.248 32.268a3 3 0 1 1-4.244-4.242l32.248-32.267a8.668 8.668 0 0 1 12.262 0 2.668 2.668 0 0 0 3.774 0L55.594 54.17c4.348-4.35 11.4-4.35 15.748 0a5.132 5.132 0 0 0 7.26 0l25.276-25.29a3 3 0 0 1 4.243-.002Z" mask="url(#s)"/>
          <path fill="#FFF" fillRule="nonzero" d="M49 150a4 4 0 0 1 4-4h120a4 4 0 0 1 4 4v144a4 4 0 0 1-4 4H53a4 4 0 0 1-4-4V150Z"/>
